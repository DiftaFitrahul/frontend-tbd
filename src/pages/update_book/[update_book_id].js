...
export default function UpdateBook() {
    ...
    return(
        <main className="grid place-items-center min-h-screen">
            ...
            <p className="text-black pb-1 text-2xl font-semibold">Update Book</p>
            ...
            <input onChange={(e) =>{
                setUpdateBook({...updateBook, language: e.target.value})
            }} className=" outline outline-2 outline-black mb-3 w-[400px]"/>
            <p className="text-black pb-1">Synopsis</p>
            <input onChange={(e) =>{
                setUpdateBook({...updateBook, synopsis: e.target.value})
            }} className=" outline outline-2 outline-black mb-3 w-[400px]"/>
            <p className="text-black pb-1">Publication Year</p>
            <input onChange={(e) =>{
                setUpdateBook({...updateBook, publication_year: Number(e.target.value)})
            }} className=" outline outline-2 outline-black mb-3 w-[400px]" type="number"/>
            <p className="text-black pb-1">Genre</p>
            <select onChange={(e) =>{
                setUpdateBook({...updateBook, genre_id: e.target.value})
            ...
            <select onChange={(e) => {
                setUpdateBook({...updateBook, publisher_id: e.target.value})
            }} className=" outline outline-2 outline-black mb-3 w-[400px] text-black">
                {
            ...
            <select onChange={(e) =>{
                setUpdateBook({...updateBook, author_id: e.target.value})
            }} className=" outline outline-2 outline-black mb-3 w-[400px] text-black">
                {
                    authors.map((author) =>{
            ...
            <select onChange={(e) => {
                setUpdateBook({...updateBook, supplier_id: e.target.value})
            }} className=" outline outline-2 outline-black mb-3 w-[400px] text-black">
                {
            ...
            <select onChange={(e) => {
                setUpdateBook({...updateBook, retail_id: e.target.value})
            }} className=" outline outline-2 outline-black mb-3 w-[400px] text-black">
                {
                    retails.map((retail) =>{
            ...
            <input onChange={(e) => { 
                setUpdateBook({...updateBook, price: Number(e.target.value)})
            }} className=" outline outline-2 outline-black mb-3 w-[400px]" type="number"/>
            <p className="text-black pb-1">Quantity</p>
            <input onChange={(e) =>{
                setUpdateBook({...updateBook, quantity: Number(e.target.value)})
            }} className=" outline outline-2 outline-black mb-3 w-[400px]" type="number"/>
            <p className="text-black pb-1">Payment Status</p>
            <input onChange={(e) => {
                setUpdateBook({...updateBook, paymen_status: e.target.value})
            }} className=" outline outline-2 outline-black mb-3 w-[400px]"/>
            <p className="text-black pb-1">Tanggal Supply</p>
            <input onChange={(e) =>{
                setUpdateBook({...updateBook, date: e.target.value})
        ...
        <div className="flex justify-center my-2 ">
            <button onClick={
                () => {
                    ...
                    axios.put(`https://embarrassed-leotard-fly.cyclic.app/book/${update_book_id}`, updateBook).then(() => {
                        router.replace('/')
                    }).catch((err) => {
                        alert(err)
                    })
